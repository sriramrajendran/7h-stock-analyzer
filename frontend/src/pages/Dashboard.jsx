...
const Dashboard = ({ recommendations, loading, onRefresh, systemHealth }) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900">🚀 7H Stock Analyzer</h1>
        ...
        <div className={`mb-6 p-4 rounded-lg border ${
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <span className={`text-2xl ${systemHealth.status === 'healthy' ? 'text-green-600' : 'text-red-600'}`}>
                {systemHealth.status === 'healthy' ? '✅' : '❌'}
              </span>
              <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6 mb-8">
        <div className="card bg-gradient-to-br from-blue-50 to-blue-100 border-l-4 border-blue-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-blue-600">Total Stocks</p>
        ...
        <div className="card bg-gradient-to-br from-green-50 to-green-100 border-l-4 border-green-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-green-600">Buy Signals</p>
        ...
        <div className="card bg-gradient-to-br from-yellow-50 to-yellow-100 border-l-4 border-yellow-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-yellow-600">Hold Signals</p>
              <p className="text-2xl font-bold text-yellow-900">{summaryStats.hold}</p>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-gradient-to-br from-red-50 to-red-100 border-l-4 border-red-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-red-600">Sell Signals</p>
        ...
        <div className="card bg-gradient-to-br from-indigo-50 to-indigo-100 border-l-4 border-indigo-500">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-indigo-600">High Confidence</p>
              <p className="text-2xl font-bold text-indigo-900">{summaryStats.highConfidence}</p>
            </div>
          </div>
        </div>
      </div>
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-4 mb-3">
                      <div className="flex items-center space-x-2">
                        <span className="text-2xl font-bold text-gray-900">{rec.symbol}</span>
                        <span className="text-2xl">{getRecommendationIcon(rec.recommendation)}</span>
                      </div>
                      <span className="text-gray-700 font-medium">{rec.company}</span>
                      ...
                      <div className="flex items-center space-x-1">
                        <span className="text-yellow-500">{'⭐'.repeat(Math.min(Math.round(rec.score), 5))}</span>
                        <span className="text-gray-400">{'☆'.repeat(Math.max(5 - Math.round(rec.score), 0))}</span>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-7 gap-4 text-sm mb-3">
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        ...
                        <div className="font-bold text-lg">{formatPrice(rec.price)}</div>
                      ...
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        ...
                        <div className="font-bold text-lg">{rec.rsi?.toFixed(1) || 'N/A'}</div>
                        <div className="text-xs text-gray-500">
                      ...
                      <div className="bg-white rounded-lg p-3 border border-gray-200">
                        ...
                        <div className="font-bold text-lg">{rec.macd?.toFixed(3) || 'N/A'}</div>
                        <div className="text-xs text-gray-500">
      ...
      {recommendations.length > 0 && (
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-green-600">{summaryStats.strongBuy}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Buy</span>
                  <span className="font-bold text-green-500">{summaryStats.buy}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Hold</span>
                  <span className="font-bold text-yellow-600">{summaryStats.hold}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Sell</span>
                  <span className="font-bold text-red-500">{summaryStats.sell}</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-sm text-gray-600">Strong Sell</span>
                  <span className="font-bold text-red-600">{summaryStats.strongSell}</span>
                </div>
              </div>
            </div>
            ...
            <div className="card">
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-bold text-green-600">{summaryStats.highConfidence}</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="card">
              <h3 className="text-lg font-semibold text-gray-900 mb-4">Technical Indicators Used</h3>
              <div className="space-y-2">
      ...
      {recommendations.length > 0 && (
        <div>
          <h2 className="text-2xl font-bold text-gray-900 mb-6">📋 All Recommendations</h2>
